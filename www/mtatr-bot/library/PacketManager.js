...
const ServerStatsHandler    = require("./handler/ServerStatsHandler");
const TradingHandler        = require("./handler/TradingHandler");
...
class PacketManager {
    ...
    _setup() {
        ...
        this.register(new ServerStatsHandler());
        this.register(new TradingHandler());
    }
